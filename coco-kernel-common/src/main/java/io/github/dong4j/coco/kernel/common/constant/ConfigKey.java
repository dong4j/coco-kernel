...
public final class ConfigKey {
    ...
    /** 框架版本 */
    public static final String APPLICATION_FRAMEWORK_VERSION = "spark.framework.version";
    /** EXTEND_ENABLE_AUTOWIRED_IS_NULL */
    public static final String EXTEND_ENABLE_AUTOWIRED_IS_NULL = "spark.extend.enable-autowired-is-null";
    /** EXTEND_ENABLE_RESOURCE_IS_NULL */
    public static final String EXTEND_ENABLE_RESOURCE_IS_NULL = "spark.extend.enable-resource-is-null";
    /** REST_ENABLE_GLOBAL_CACHE_FILTER */
    public static final String WEB_ENABLE_GLOBAL_CACHE_FILTER = "spark.web.enable-global-cache-filter";
    /** REST_ENABLE_EXCEPTION_FILTER */
    public static final String WEB_ENABLE_EXCEPTION_FILTER = "spark.web.enable-exception-filter";
    /** REST_ENABLE_REQUEST_LOG */
    public static final String REST_ENABLE_REQUEST_LOG = "spark.rest.enable-request-log";
    /** REST_ENABLE_GLOBAL_PARAMETER_FILTER */
    public static final String REST_ENABLE_GLOBAL_PARAMETER_FILTER = "spark.rest.enable-global-parameter-filter";
    /** XSS_ENABLE_XSS_FILTER */
    public static final String XSS_ENABLE_XSS_FILTER = "spark.xss.enable-xss-filter";
    /** JSON_TIME_ZONE */
    public static final String JSON_TIME_ZONE = "spark.rest.json.time-zone";
    /** JSON_DATE_FORMAT */
    public static final String JSON_DATE_FORMAT = "spark.rest.json.date-formate";
    /** jackson null 处理配置 */
    public static final String JSON_SERIALIZE_NULL = "spark.rest.json.default-property-inclusion";
    /** MYBATIS_ENABLE_ILLEGAL_SQL_INTERCEPTOR */
    public static final String MYBATIS_ENABLE_ILLEGAL_SQL_INTERCEPTOR = "spark.mybatis.enable-illegal-sql-interceptor";
    /** MYBATIS_ENABLE_SQL_EXPLAIN_INTERCEPTOR */
    public static final String MYBATIS_ENABLE_SQL_EXPLAIN_INTERCEPTOR = "spark.mybatis.enable-sql-explain-interceptor";
    /** POM_INFO_VERSION */
    ...
    /** SERVICE_VERSION */
    public static final String SERVICE_VERSION = "spark.service.version";
    /** JASYPT_ENCRYPTOR_PASSWORD */
    public static final String JASYPT_ENCRYPTOR_PASSWORD = "jasypt.encryptor.password";
    /** 是否开启 banner */
    public static final String SPARK_ENABLE_BANNER = "spark.enable-banner";
    /** 应用分组 */
    public static final String SPARK_APP_GROUP = "spark.app.group";
    /** SPARK_APP_CONFIG_GROUP */
    public static final String SPARK_APP_CONFIG_GROUP = "spark.app.config-group";
    /** DISCOVERY_GROUP */
    public static final String SPARK_APP_DISCOVERY_GROUP = "spark.app.discovery-group";
    ...
    public static class LogSystemConfigKey {
        /** 日志应用名 */
        public static final String LOG_APP_NAME = "spark.logging.app-name";
        /** 是否现在 location 信息 */
        public static final String SHOW_LOG_LOCATION = "spark.logging.enable-show-location";

        /** 日志等级 */
        public static final String LOG_LEVEL = "spark.logging.level";
        /** 日志分组 */
        public static final String LOG_GROUP = "spark.logging.group";
        /** 日志系统配置文件 */
        public static final String LOG_CONFIG = "spark.logging.config";

        /** LOG_FILE */
        public static final String LOG_FILE = "spark.logging.file";
        /** 日志文件名 */
        public static final String LOG_FILE_NAME = "spark.logging.file.name";
        /** 日志文件保存路径 */
        public static final String LOG_FILE_PATH = "spark.logging.file.path";
        /** 是否在启动应用时清理历史日志 */
        public static final String LOG_FILE_CLEAN_HISTORY = "spark.logging.file.clean-history-on-start";
        /** 最大允许保存的日志历史 */
        public static final String LOG_FILE_MAX_HISTORY = "spark.logging.file.max-history";
        /** 日志文件最大容量 */
        public static final String LOG_FILE_MAX_SIZE = "spark.logging.file.max-size";
        /** 日志文件最大数量 */
        public static final String LOG_FILE_TOTAL_SIZE_CAP = "spark.logging.file.total-size-cap";

        /** LOG_PATTERN */
        public static final String LOG_PATTERN = "spark.logging.pattern";
        /** LOG_PATTERN_CONSOLE */
        public static final String LOG_PATTERN_CONSOLE = "spark.logging.pattern.console";
        /** LOG_PATTERN_FILE */
        public static final String LOG_PATTERN_FILE = "spark.logging.pattern.file";
        /** LOG_PATTERN_LEVEL */
        public static final String LOG_PATTERN_LEVEL = "spark.logging.pattern.level";
        /** LOG_PATTERN_DATEFORMAT */
        public static final String LOG_PATTERN_DATEFORMAT = "spark.logging.pattern.dateformat";
        /** ROLLING_FILE_NAME */
        public static final String ROLLING_FILE_NAME = "spark.logging.pattern.rolling-file-name";
        /** MARKER_PATTERN */
        public static final String MARKER_PATTERN = "spark.logging.pattern.marker";
    ...
    public static class NacosConfigKey {
        /** 配置中心地址 */
        public static final String SPARK_CONFIG = "spark.nacos.config.";
        /** CONFIG_SERVER_ADDRESS */
        public static final String CONFIG_SERVER_ADDRESS = SPARK_CONFIG + "server-addr";
        /** 配置中心 namespace */
        public static final String CONFIG_NAMESPACE = SPARK_CONFIG + "namespace";
        /** 配置中心 dataId */
        public static final String CONFIG_DATA_ID = SPARK_CONFIG + "data-id";
        /** 配置中心 分组 */
        public static final String CONFIG_GROUP = SPARK_CONFIG + "group";
        /** SPARK_DISCOVERY */
        public static final String SPARK_DISCOVERY = "spark.nacos.discovery.";
        /** 服务注册与发现地址 */
        public static final String DISCOVERY_SERVER_ADDR = SPARK_DISCOVERY + "server-addr";
        /** 服务注册与发现 namespace */
        public static final String DISCOVERY_NAMESPACE = SPARK_DISCOVERY + "namespace";
        /** 服务注册与发现 分组 */
        public static final String DISCOVERY_GROUP = SPARK_DISCOVERY + "group";
        /** 是否自动创建配置 */
        public static final String ENABLE_AUTO_CREATE_CONFIG = "spark.nacos.enable-auto-create-config";
        /** 是否使用 Nacos 配置 */
        public static final String ENABLE_NACOS_CONFIG = "spark.nacos.enable-nacos-config";
    ...
    public static class MongoConfigKey {
        ...
        public static final String ENABLE_AUTO_INCREMENT_KEY = "spark.mongo.enable-auto-increment-key";
        /** ENABLE_AUTO_CREATE_INDEX */
        public static final String ENABLE_AUTO_CREATE_INDEX = "spark.mongo.enable-auto-create-index";
        /** ENABLE_AUTO_CREATE_KEY */
        public static final String ENABLE_AUTO_CREATE_KEY = "spark.mongo.enable-auto-create-key";
        /** ENABLE_AUTO_CREATE_TIME */
        public static final String ENABLE_AUTO_CREATE_TIME = "spark.mongo.enable-auto-create-time";
    }
    ...
    public static class MybatisConfigKey {
        /** PAGE */
        public static final String PAGE = "spark.mybatis.page";
        /** LIMIT */
        public static final String LIMIT = "spark.mybatis.limit";
        /** MYBATIS_ENABLE_LOG */
        public static final String MYBATIS_ENABLE_LOG = "spark.mybatis.enable-log";
        /** MYBATIS_ENABLE_SENSITIVE */
        public static final String MYBATIS_ENABLE_SENSITIVE = "spark.mybatis.enable-sensitive";
        /** MAPPER_LOCATIONS */
    ...
    public static class FeignConfigKey {
        /** FEIGN_URL_PROFIX */
        public static final String FEIGN_URL_PROFIX = "spark.feign.url.";
        /** RIBBON_SERVICE_LIST */
        public static final String RIBBON_SERVICE_LIST = "spark.feign.ribbon.list-of-servers";
        /** MAX_AUTO_RETRIES */
        public static final String MAX_AUTO_RETRIES = "spark.feign.ribbon.max-auto-retries";
        /** MAX_AUTO_RETRIES_NEXT_SERVER */
        public static final String MAX_AUTO_RETRIES_NEXT_SERVER = "spark.feign.ribbon.max-auto-retries-next-server";
        /** OK_TO_RETRY_ON_ALL_OPERATIONS */
        public static final String OK_TO_RETRY_ON_ALL_OPERATIONS = "spark.feign.ribbon.ok-to-retry-on-all-operations";
        /** SERVER_LIST_REFRESH_INTERVAL */
        public static final String SERVER_LIST_REFRESH_INTERVAL = "spark.feign.ribbon.server-list-refresh-interval";
        /** CONNECT_TIMEOUT */
        public static final String CONNECT_TIMEOUT = "spark.feign.ribbon.connect-timeout";
        /** READ_TIMEOUT */
        public static final String READ_TIMEOUT = "spark.feign.ribbon.read-timeout";
    }
    ...
    public static class AgentConfigKey {
        /** agent 路由服务后缀, 服务端需要依赖 spark-agent-spring-boot-starter */
        ...
        /** FEIGN_URL_PROFIX */
        public static final String FEIGN_URL_PROFIX = "spark.agent.url.";
         ...
         */
        @Deprecated
        public static final String RIBBON_SERVICE_LIST = "spark.agent.ribbon.list-of-servers";
        /** GATEWAY_SERVICE_LIST */
        public static final String GATEWAY_SERVICE_LIST = "spark.gateway.servers";
        /**
         * SERVER_LIST_REFRESH_INTERVAL
         *
         ...
         */
        @Deprecated
        public static final String SERVER_LIST_REFRESH_INTERVAL = "spark.agent.ribbon.server-list-refresh-interval";
        /** GATEWAY_SERVER_LIST_REFRESH_INTERVAL */
        public static final String GATEWAY_SERVER_LIST_REFRESH_INTERVAL = "spark.gateway.server-list-refresh-interval";
        /**
         * CONNECT_TIMEOUT
         *
         ...
         */
        @Deprecated
        public static final String CONNECT_TIMEOUT = "spark.agent.ribbon.connect-timeout";
        /** GATEWAY_CONNECT_TIMEOUT */
        public static final String GATEWAY_CONNECT_TIMEOUT = "spark.gateway.connect-timeout";
        /**
         * READ_TIMEOUT
         *
         ...
         */
        @Deprecated
        public static final String READ_TIMEOUT = "spark.agent.ribbon.read-timeout";
        /** GATEWAY_READ_TIMEOUT */
        public static final String GATEWAY_READ_TIMEOUT = "spark.gateway.read-timeout";
        /**
         * 是否开启路由转发
         *
         ...
         */
        @Deprecated
        public static final String REST_ENABLE_ROUTER = "spark.agent.rest.enable-router";
        /** GATEWAY_REST_ENABLE_ROUTER */
        public static final String GATEWAY_REST_ENABLE_ROUTER = "spark.gateway.enable-router";
        /** GATEWAY_REST_ENABLE_endpoint */
        public static final String GATEWAY_REST_ENABLE_ENDPOINT = "spark.gateway.enable-endpoint";
        /**
         * request 请求最大长度限制
         *
         ...
         */
        @Deprecated
        public static final String REQUEST_MAX_LINE_LENGTH = "spark.agent.rest.request-max-line-length";
        /** GATEWAY_REQUEST_MAX_LINE_LENGTH */
        public static final String GATEWAY_REQUEST_MAX_LINE_LENGTH = "spark.gateway.request-max-line-length";


        /** 全局重复提交检查 (如果为 false, 则不再检查每个 agent 服务是否需要检查) */
        public static final String ENABLE_REPLY_CHECK = "spark.agent.endpoint.enable-reply-check";
        /** 全局签名检查 (如果为 false, 则不再检查每个 agent 服务是否需要检查) */
        public static final String ENABLE_SIGN_CHECK = "spark.agent.endpoint.enable-sign-check";
        /** 启动时检查 agent service 写法是否正确 */
        public static final String ENABLE_FAIL_FAST = "spark.agent.endpoint.enable-fail-fast";
    }
    ...
    public static class ScheduleConfigKey {
        /** ENABLE */
        public static final String ENABLE = "spark.schedule.enable";
        /** EXECUTOR_APP_NAME */
        public static final String EXECUTOR_APP_NAME = "spark.schedule.executor.app-name";
        /** EXECUTOR_APP_IP */
        public static final String EXECUTOR_APP_IP = "spark.schedule.executor.id";
        /** EXECUTOR_APP_PORT */
        public static final String EXECUTOR_APP_PORT = "spark.schedule.executor.port";
        /** EXECUTOR_APP_LOG_PATH */
        public static final String EXECUTOR_APP_LOG_PATH = "spark.schedule.executor.log-path";
        /** EXECUTOR_APP_LOG_RETENTIONDAYS */
        public static final String EXECUTOR_APP_LOG_RETENTIONDAYS = "spark.schedule.executor.log-retention-days";
        /** SCHEDULE_ACCESSTOKEN */
        public static final String SCHEDULE_ACCESSTOKEN = "spark.schedule.access-token";
        /** SCHEDULE_ADMIN_ADDRESSES */
        public static final String SCHEDULE_ADMIN_ADDRESSES = "spark.schedule.admin-addresses";
    }
    ...
    public static class MqConfigKey {
        ...
        /** BOOTSTRAP_SERVERS */
        public static final String BOOTSTRAP_SERVERS = "spark.mq.kafka.bootstrap-servers";
        /** NAME_SERVER_ADDRESS */
        public static final String NAME_SERVER_ADDRESS = "spark.mq.rocketmq.name-server-address";
    }
    ...
    public static class LogcatConfigKey {
        /** ADMIN_URL */
        public static final String ADMIN_URL = "spark.logcat.server.url";
    }
}
